...
public:
    ...
    QDoubleSpinBox *firstHitThresBox;
    QLabel *label_6;
    QRadioButton *alphaRadio;
    QCheckBox *gpuBox;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        interpolationBox->setGeometry(QRect(650, 160, 161, 91));
        ...
        rotationSpeed->setMinimum(-50);
        rotationSpeed->setMaximum(50);
        rotationSpeed->setSingleStep(0.01);
        ...
        renderingBox->setGeometry(QRect(810, 160, 161, 121));
        ...
        firstHitRadio->setGeometry(QRect(20, 80, 61, 17));
        firstHitRadio->setCheckable(false);
        firstHitThresBox = new QDoubleSpinBox(renderingBox);
        firstHitThresBox->setObjectName(QStringLiteral("firstHitThresBox"));
        firstHitThresBox->setGeometry(QRect(90, 80, 61, 22));
        firstHitThresBox->setDecimals(2);
        firstHitThresBox->setSingleStep(0.01);
        label_6 = new QLabel(renderingBox);
        label_6->setObjectName(QStringLiteral("label_6"));
        label_6->setGeometry(QRect(90, 100, 51, 20));
        alphaRadio = new QRadioButton(renderingBox);
        alphaRadio->setObjectName(QStringLiteral("alphaRadio"));
        alphaRadio->setGeometry(QRect(20, 50, 121, 17));
        alphaRadio->setCheckable(false);
        gpuBox = new QCheckBox(centralwidget);
        gpuBox->setObjectName(QStringLiteral("gpuBox"));
        gpuBox->setGeometry(QRect(660, 130, 231, 17));
        ...
        label_7->setGeometry(QRect(660, 60, 291, 21));
        label_8 = new QLabel(centralwidget);
        label_8->setObjectName(QStringLiteral("label_8"));
        label_8->setGeometry(QRect(660, 80, 301, 16));
        label_9 = new QLabel(centralwidget);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setGeometry(QRect(660, 100, 291, 16));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_6->setText(QApplication::translate("MainWindow", "Threshold", 0));
        alphaRadio->setText(QApplication::translate("MainWindow", "Alpha Compositing", 0));
        ...
        label_7->setText(QApplication::translate("MainWindow", "Some program features are only available, when the GPU ", 0));
        label_8->setText(QApplication::translate("MainWindow", "is enabled (like Alpha-Compositing, Translation and Zoom). On", 0));
        label_9->setText(QApplication::translate("MainWindow", "the GPU everything should work (as far as tested).", 0));
